...
import { createPdfReportResponse } from "@/lib/export/reportExportRouteHandlers";
...
export async function GET(request: Request, context: RouteContext) {
  ...
  const response = await createPdfReportResponse(id, project as unknown as Record<string, unknown>, locale);
